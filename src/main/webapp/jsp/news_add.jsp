    ...
    <div class="col p-0">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-bars pr-1"></i>  当前位置：公告管理 > 添加公告
            </div>
            <div class="col bg-light">
                <div class="bg-light mb-4">
                    ...
                    <div class="row">
                        <div class="col mt-5">
                            <form action="<%=request.getContextPath()%>/tNews/addOne" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col">
                                        <label for="validationDefault01">公告标题</label>
                                        <input type="text" name="nTitle" class="form-control" id="validationDefault01" required>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="text" name="nDesc" class="form-control" id="validationDefault02"required>
                                        <div class="invalid-feedback">
                                            公告简介不能为空
                                        </div>
                                        <div class="valid-feedback">
