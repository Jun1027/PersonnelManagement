    ...
    <div class="col p-0">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-bars pr-1"></i>  当前位置：职位管理 > 添加职位
            </div>
            <div class="col bg-light">
                <div class="bg-light mb-4">
                    ...
                    <div class="row">
                        <div class="col mt-5">
                            <form action="<%=request.getContextPath()%>/tPosition/addOne" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                ...
                                <div class="row mt-3">
                                    <div class="col-8 offset-2">
                                        ...
                                        <input type="text" name="pInfo" class="form-control" id="validationDefault02" required>
                                        <div class="invalid-feedback">
                                            职位简介不能为空
                                        </div>
                                        <div class="valid-feedback">
